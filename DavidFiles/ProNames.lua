...
DevAli:set(DAli.."Ali:ProNames:Num"..msg.chat_id_,Num)
else
send(msg.chat_id_, msg.id_,'⌁︙ميزة التوحيد معطله يرجى تفعيلها')
end
end
...
if DevAli:get(DAli.."Ali:ProNames:Txt"..msg.chat_id_) then
local ProNamesTxt = DevAli:get(DAli.."Ali:ProNames:Txt"..msg.chat_id_)
local ProNamesNum = DevAli:get(DAli.."Ali:ProNames:Num"..msg.chat_id_) or 5
...
if DevAli:get(DAli.."Ali:Lock:ProNames"..msg.chat_id_) and DevAli:get(DAli.."Ali:ProNames:Txt"..msg.chat_id_) then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result and result.first_name_ then 
if result.first_name_:match("(.*)"..DevAli:get(DAli.."Ali:ProNames:Txt"..msg.chat_id_).."(.*)") then 
DevAli:srem(DAli..'Ali:Muted:'..msg.chat_id_, msg.sender_user_id_)
else
local ProNamesTxt = DevAli:get(DAli.."Ali:ProNames:Num"..msg.chat_id_) or 5
local UserNum = DevAli:get(DAli.."Ali:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(UserNum) == tonumber(ProNamesTxt) or tonumber(UserNum) > tonumber(ProNamesTxt)) then 
DevAli:sadd(DAli..'Ali:Muted:'..msg.chat_id_, msg.sender_user_id_)
DevAli:del(DAli.."Ali:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_)
...
DevAli:set(DAli.."Ali:Lock:ProNames"..msg.chat_id_,true)
end
if text == "تعطيل التوحيد" and Constructor(msg) then
send(msg.chat_id_, msg.id_, '⌁︙تم تعطيل توحيد المجموعه')
DevAli:del(DAli.."Ali:Lock:ProNames"..msg.chat_id_)
end
end
