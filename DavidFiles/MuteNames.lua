...
if DevAli:get(Dali.."Ali:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAli:sadd(Dali.."Ali:Mute:Names"..msg.chat_id_, MuteName)
end
...
if not Manager(msg) and DevAli:get(Dali.."Ali:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
DaliName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if DaliName then 
DaliNames = DevAli:smembers(Dali.."Ali:Mute:Names"..msg.chat_id_) or ""
if DaliNames and DaliNames[1] then 
for i=1,#DaliNames do 
if DaliName:match("(.*)("..DaliNames[i]..")(.*)") then 
...
DevAli:set(Dali.."Ali:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAli:del(Dali.."Ali:Lock:MuteNames"..msg.chat_id_)
end
end
end
