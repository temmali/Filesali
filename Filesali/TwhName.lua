...
database:set(bot_id.."Dali:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."Dali:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."Dali:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."Dali:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."Dali:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function keko_tsahke_new(tshake1,tshake2)
if tshake2 and tshake2.first_name_ then 
if tshake2.first_name_:match("(.*)"..database:get(bot_id.."Dali:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."Dali:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local tshake_nnn = database:get(bot_id.."Dali:nump"..msg.chat_id_) or 5
local tshake_nnn2 = database:get(bot_id.."Dali:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(tshake_nnn2) == tonumber(tshake_nnn) or tonumber(tshake_nnn2) > tonumber(tshake_nnn)) then 
database:sadd(bot_id.."Dali:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."Dali:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌔︙عزيزي >>["..tshake2.username_.."](https://t.me/"..(tshake2.username_ or "tshaketeam")..")\n⌔︙عليك وضع التوحيد ~⪼ {`"..database:get(bot_id.."Dali:teh"..msg.chat_id_).."`} بجانب اسمك\n⌔︙عدد المحاولات المتبقيه {"..(tonumber(tshake_nnn) - tonumber(tshake_nnn2)).."}")
end
end
end
end
