...
database:sadd(bot_id.."Dali:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."Dali:blocname"..msg.chat_id_)
...
if name_Black then 
names_Black = database:smembers(bot_id.."Dali:blocname"..msg.chat_id_) or ""
